...
public class Questrade {
     ...
     * time that a {@code Questrade} object is created and the time that it's activated.
    ...
    /**
     * <b>Temporary storage variable.</b> Authorization that is created in {@link #Questrade(String, String, String)}. Meant to use cached data
     * to save doing an API request. This is {@code null} if the {@link #Questrade(String)} constructor is used
     * or after {@link #activate()} is called when the {@link #Questrade(String, String, String)} constructor is used.
     */
    private Authorization startingAuthorization;

    /**
     * Creates an instance of the {@code Questrade} wrapper, whose methods can be used to access the Questrade API.
    ...
    public void revokeAuthorization() {
        String URL = "https://login.questrade.com/oauth2/token?grant_type=refresh_token&refresh_token=%s".formatted(authorization.getRefreshToken());
     ...
     * @param orderIds      An array containing all the orders IDs to get information for.
     ...
     * The Questrade API <b>GET accounts/:id/orders[/:orderId]</b> documentation</a>
     */
    public Order[] getOrders(String accountNumber,
                             ZonedDateTime startTime,
                             ZonedDateTime endTime,
                             OrderState orderState) throws RefreshTokenException {
        if ( startTime.isAfter(endTime) ) {
            throw new TimeRangeException("The startTime must be earlier than the endTime.");
        }
